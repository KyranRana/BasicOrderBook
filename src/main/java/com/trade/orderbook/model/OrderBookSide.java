...
public abstract class OrderBookSide {
    ...
    private void addOrderToPriceLevel(Order order) {
        OrderNodes priceLevelOrders = priceLevels
                .computeIfAbsent(order.getPrice(), k -> new OrderNodes());
    ...
    private void validateOrder(Order order) {
        ...
        checkArgument(order.getSide().equals(getSide()),
                String.format("Order must be a %s order!", getSide()));
    }
